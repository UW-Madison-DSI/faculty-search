...
def test_engine(author_collection, article_collection, embeddings):
    ...
    author = engine.get_author(106927)
    ...
    articles = engine.search_articles("Dark Higgs Boson", top_k=3)
    ...
    author_ids, scores = engine.search_authors("Dark Higgs Boson", top_k=3)
