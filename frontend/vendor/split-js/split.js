...
var Split = function (ids, options) {
    ...
    var gutterSize = options.gutterSize !== undefined ? options.gutterSize : 20;
    ...
    elements = ids.map(function (id, i) {
        ...
        if (!isIE8) {
            ...
            if (i > 0) {
                ...
                gutterElement[addEventListener]('touchstart', startDragging.bind(pair), {passive: true});
