...
# Flask
docker compose cp /etc/letsencrypt/live/discover.datascience.wisc.edu/cert.pem flask:/app/cert.pem
docker compose cp /etc/letsencrypt/live/discover.datascience.wisc.edu/privkey.pem flask:/app/privkey.pem
